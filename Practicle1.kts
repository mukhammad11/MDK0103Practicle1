fun main(args: Array<String>) {
    ...
    //  задание 2
    val MyAge: Int = 18 // объявление константы, котороя содержит мой возраст
    exercisesSolved =+ exercisesSolved + 1; // увеличение переменной на 1
    // конец задания 2
    ...
    // задание 6
    var age = 16 // обьявляем переменную, используем var, т.к далее переменная будет изменяться
    print(age)
    age = 30
    print(age)
    exercisesSolved =+ exercisesSolved + 1;//
    ...
    // задание 9
    val a = 18.0 // обьявляем константу а
    val b = 12.0 // обьявляем константу b
    val average = (a + b) /2 // вчисление средней арефмитической
    exercisesSolved =+ exercisesSolved + 1;
    // конец задания 9